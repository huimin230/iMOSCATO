...
- z: a vector of non-negative integers indicating the initial assignments of spatial domains. Starting from 0 and ending by D-1, where D is the specified number of spatial domains. z can use ground truth or can be found by other clustering methods if find_domian is `FALSE`.
